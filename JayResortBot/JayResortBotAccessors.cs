...
{
    public class JayResortBotAccessors
    {
        public JayResortBotAccessors(UserState userState, ConversationState conversationState)
        {
        ...
        public static string DialogStateName { get; } = $"{nameof(JayResortBotAccessors)}.DialogState";
